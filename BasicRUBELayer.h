...
class BasicRUBELayer : public Layer
{
public:
    CREATE_FUNC(BasicRUBELayer);
     static Scene* scene();                           // returns a Scene that contains the HelloWorld as the only child
    ...
    virtual Layer* setupMenuLayer();                 // only for this demo project, you can remove this in your own app
    ...
    virtual void draw(Renderer *renderer, const kmMat4& transform, bool transformUpdated);// standard Cocos2d layer method
    ...
    // virtual void ccTouchesCancelled(cocos2d::CCSet* touches, cocos2d::Event* event);
